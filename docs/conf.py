#!/usr/bin/env python
"""
llama2 documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "llama2"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import llama2.core  # noqa
...
project = "llama2"
_full_version = llama2.core.__version__
author = llama2.core.__author__
copyright = llama2.core.__copyright__
